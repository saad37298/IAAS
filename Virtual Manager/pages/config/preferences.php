...
$sql = "CREATE TABLE IF NOT EXISTS  ( name VARCHAR(255), value VARCHAR(255), userid int );";
...
if (isset($_SESSION['cert_path'])) {
  ...
  $sql = "SELECT name FROM  WHERE name = 'cert_path';";
  $result = $conn->query($sql);

  if (mysqli_num_rows($result) == 0 ) {
    $sql = "INSERT INTO  (name, value) VALUES ('cert_path', '$cert_path');";
    $result = $conn->query($sql);
  } else {
    $sql = "UPDATE  SET value = '$cert_path' WHERE name = 'cert_path';";
    $result = $conn->query($sql);
  }
...
if (isset($_SESSION['themeColorChange'])) {
  ...
  $sql = "SELECT name FROM  WHERE name = 'theme_color' AND userid = '$userid';";
  $result = $conn->query($sql);
...
if (isset($_SESSION['language'])) {
  ...
  $sql = "SELECT name FROM  WHERE name = 'language' AND userid = '$userid';";
  $result = $conn->query($sql);

  if (mysqli_num_rows($result) == 0 ) {
    $sql = "INSERT INTO  (name, value, userid) VALUES ('language', '$language', '$userid');";
    $result = $conn->query($sql);
  } else {
    $sql = "UPDATE  SET value = '$language' WHERE name = 'language' AND userid = '$userid';";
    $result = $conn->query($sql);
  }
...
if ($_SESSION['password'] === $_SESSION['confirm_password'] && $_SESSION['password'] != "") {
  ...
  $sql = "SELECT value FROM  WHERE name = 'cert_path' LIMIT 1;";
  $result = $conn->query($sql);
  if (mysqli_num_rows($result) != 0 ) {
